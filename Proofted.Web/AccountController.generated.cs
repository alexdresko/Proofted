...
namespace Proofted.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : Proofted.Web.Controllers.AccountController
    {
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Proofted.Web.Models.Security.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(Proofted.Web.Models.Security.RegisterExternalLoginModel model, string returnUrl)
        {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Proofted.Web.Models.Security.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(Proofted.Web.Models.Security.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Proofted.Web.Controllers.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(Proofted.Web.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Proofted.Web.Models.Security.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(Proofted.Web.Models.Security.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Proofted.Web.Models.Security.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(Proofted.Web.Models.Security.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
